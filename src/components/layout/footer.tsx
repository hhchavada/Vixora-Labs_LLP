          ...
          <div className="w-full md:w-1/2 lg:w-[22%] sm:px-[15px] lg:px-0 relative mt-8 lg:mt-0 flex flex-col">
            ...
            <div className="mb-5 flex gap-3 items-start text-[#a3a3a3] font-light leading-normal">
              ...
              <div className="flex flex-col gap-1">
                ...
                <a href="https://maps.app.goo.gl/28MKLfsfPQn9dfyJ7" target="_blank" rel="noopener noreferrer" className="text-[#a3a3a3] text-[16px] font-light hover:text-white transition-colors mt-1 w-fit">Google map</a>
              </div>
            </div>

            <div className="flex gap-3 sm:gap-5 lg:mt-7 md:mt-5 mt-5">
              <a href="https://www.linkedin.com/company/vixora-labs-llp" target="_blank" rel="noopener noreferrer" className="w-[34px] h-[34px] rounded-full bg-white hover:bg-[#1c1c1c] hover:text-white flex items-center justify-center transition-colors text-black">
                <FaLinkedinIn className="text-[18px]" />
              </a>
              <a href="https://www.instagram.com/vixoralabs.in/" target="_blank" rel="noopener noreferrer" className="w-[34px] h-[34px] rounded-full bg-white hover:bg-[#1c1c1c] hover:text-white flex items-center justify-center transition-colors text-black">
                <FaInstagram className="text-[18px]" />
              </a>
              <a href="https://www.facebook.com/profile.php?id=61592461121658" target="_blank" rel="noopener noreferrer" className="w-[34px] h-[34px] rounded-full bg-white hover:bg-[#1c1c1c] hover:text-white flex items-center justify-center transition-colors text-black">
